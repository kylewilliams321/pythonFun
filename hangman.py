...
#The number of turns before the player Loses (maybe upgrade this, how many guesses input?)
failureCount=6
...
while failureCount > 0:
    ...
    #Get the guessed Letters from the player
    ...
    #Maintain a list of all letters guessed so far
    ...
    #If wrongLetterCount is 0 then you win!
